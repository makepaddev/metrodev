...
class HtmlCodeEditor extends require('./HtmlWidget') {
    ...
    properties() {
        ...
        this.dependencies = {
            ...
            ContextEditor:require('./HtmlContextEditor').extend({
                ...
                onStartChanges(){
                    this.parentWidget.parentWidget.onStartChanges()
                },
                onEndChanges(){
                    this.parentWidget.parentWidget.onEndChanges()
                }
            }),
            EditContainer:{
                type:'View',
    ...
    onStartChanges(){
        ...
        codeEditor.groupUndoStart();
    }

    onEndChanges(){
        var codeEditor = this.childViewByType('EditContainer').childWidgetByType('Splitter').getSplitted()[0]
        codeEditor.groupUndoEnd();
    }
    ...
    onCursorChange(row, col, data){
        ...
        // cant do this, ace goes crazy
        //this.childViewByType('EditContainer').childWidgetByType('Splitter').setFold(fold);
    }
