...
class HtmlColorPicker extends require('./HtmlWidget') {
    ...
    updateColor(){
        // manipulates the DOM representing this editor
        ...
        this.childViewById('HueEdit').setText(parseInt(this.hue))
        this.childViewById('SatEdit').setText(parseInt(this.sat*100)+'%')
        this.childViewById('LgtEdit').setText(parseInt(this.lgt*100)+'%')
        this.childViewById('AlphaEdit').setText(parseFloat(this.alpha).toFixed(2))
    }
